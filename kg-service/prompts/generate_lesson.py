...
```json
{
  ...
  "philosophy_summary": "2-3 sentences explaining why this lesson fits within the chosen educational philosophy. Reference specific principles or methods. Omit if philosophy is 'flexible'.",
  "content_hash": null
}
```
