...
/**
 * Snake-case keys mirror the DB lesson_sections shape so the same renderer
 * (LessonSectionsDisplay) can be used for live lessons and samples.
 */
...
export interface SampleLesson {
  ...
  subject: string;
  subjects?: string[];
  /** Short marketing hook shown on the results page CTA and sample page header */
  teaser?: string;
    ...
    "sections": [
      {
        ...
        "extensions": [
          "Add gentle ‘coaching and drilling’: repeat the lines once more at the end of the lesson to strengthen memory.",
          "If you have a poetry anthology, let her choose between two flower poems (choice within structure)."
        ],
        "philosophy_connection": "This sets an orderly Trivium pathway and begins with memorization/recitation—foundational classical tools for language mastery."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Compare two short flower poems and ask: “How do the poets treat the same topic differently?” (tone, word choice, mood).",
          "Have her outline the poem’s ‘parts’ (stanzas) with a one-phrase label for each stanza (parts-to-whole)."
        ],
        "philosophy_connection": "Classical learning is word-centered and discussion-based; Clementine practices attentive reading, narration, and citing the author’s words (a primary text) as evidence."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Put the words on index cards and do a quick oral drill: you say the word, she gives a synonym; you say a synonym, she finds the word.",
          "Add one ‘poet’s choice’ note: ask how the meaning changes if you swap in the synonym (tone/precision)."
        ],
        "philosophy_connection": "This is classical ‘grammar’ work: building precise vocabulary through definition, relationships among words, and repeated practice for mastery."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Invite her to classify the flower informally: wild/garden; single bloom/cluster; tall/short; and explain her reasons.",
          "Collect one fallen petal/leaf and tape it into the notebook as a ‘specimen’ (if permitted)."
        ],
        "philosophy_connection": "Classical education values careful observation and precise language; this section supplies concrete ‘matter’ for later rhetoric (composition) and strengthens vocabulary with real-world referents."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Have her create a ‘final copy’ page with neat handwriting and a small illustration for a poetry notebook.",
          "Ask her to write a 2-sentence explanation of her poem’s theme and point to one line that shows it (evidence)."
        ],
        "philosophy_connection": "This culminates in rhetoric: expressing ideas beautifully and clearly, built on earlier grammar work (vocabulary) and logic work (theme/evidence). Reading aloud and revising reflect classical composition habits."
      }
    ],
    "standards": [],
    ...
    "sections": [
      {
        ...
        "extensions": [
          "Add a simple ‘work rug’ or mat where she can lay out cards in neat rows (supports order and concentration)."
        ],
        "philosophy_connection": "You create a prepared environment with orderly, accessible materials, then offer freedom within structure by letting Mary choose the observation site and recording method."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Do a second 3-minute observation in a nearby micro-habitat (under a shrub, near a puddle, by a garden bed) and compare what changes."
        ],
        "philosophy_connection": "This is reality-based, sensory learning in nature (Cosmic Education), with the adult as observer. Mary gathers real evidence and classifies it from concrete experience."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Add a fourth heading: ‘I’m not sure yet’ to honor uncertainty and encourage further observation."
        ],
        "philosophy_connection": "Montessori-style classification builds mental order from concrete experience, isolates the difficulty (sorting by one attribute), and supports independence through self-correction."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Add nonliving supports as side cards (sunlight, water, soil) and connect them to the plant.",
          "Create a second web for a different season or weather condition (dry day vs. rainy day) using ‘what might change?’ cards."
        ],
        "philosophy_connection": "This moves from concrete observation to an abstract idea (interdependence) through hands-on modeling, supporting Cosmic Education and child-led discovery."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Leave the chosen design outside for a week and check it briefly each day for signs of use (without disturbing wildlife)."
        ],
        "philosophy_connection": "This is practical, purposeful work (Preparation for Life) grounded in real needs of living things, and it includes simple engineering comparison with minimal adult intervention."
      }
    ],
    "standards": [],
    ...
    "sections": [
      {
        ...
        "extensions": [
          "Add a quick 'stakeholder list' brainstorm: homeowners, renters, kids, city parks staff, Indigenous communities, foragers, gardeners, wildlife."
        ],
        "philosophy_connection": "You’re grounding learning in direct local experience and building stewardship values (care, restraint, safety) before going outside—classic place-based learning with a balance of safety and freedom."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Do a second mini-loop focused only on 'movement': Where might seeds/fruit move (wind, birds, people, lawnmowers) and how does that shape what grows where?"
        ],
        "philosophy_connection": "This is direct nature experience and sensory-rich observation rooted in your immediate place. It treats the neighborhood as the classroom and centers inquiry through doing."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Add a second layer: mark 'wildlife users' (birds, squirrels, insects) to discuss shared resources and stewardship."
        ],
        "philosophy_connection": "Place-based learning becomes visible through mapping—connecting lived experience to geographic representation and analysis. It also supports learner agency as Natalie chooses symbols, categories, and patterns."
      },
      {
        "type": "reflection",
        ...
        "extensions": [
          "Draft a short persuasive note or script Natalie could use to request permission to harvest from a neighbor, including respectful reasoning and an offer to share."
        ],
        "philosophy_connection": "This connects human-environment relationships to civic life and stewardship, building from local observation to values, community norms, and possible participation—core to place-nature-based education."
      },
      {
        "type": "transition",
        ...
        "extensions": [
          "Start a year-long 'edible calendar' page with months and notes about what might appear when."
        ],
        "philosophy_connection": "Honors seasonal rhythms and sustained inquiry over time—learning through repeated relationship with the same place."
      }
    ],
    "standards": [],
    ...
    "sections": [
      {
        ...
        "extensions": [
          "Add a collaboration element by inviting Penny to text/email a friend or relative to vote on which creature seems most “place-based,” then use that as a reason for her choice."
        ],
        "philosophy_connection": "You launch an authentic project with a clear audience and product, then co-create a compelling driving question to guide sustained inquiry."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Take 2–3 photos on the walk and later label them as ‘habitat features’ in her final product (e.g., water source, rocky shelter)."
        ],
        "philosophy_connection": "Fieldwork makes the inquiry experiential and place-based, helping Penny construct knowledge from observation and then translate it into research questions."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Add a quick ‘bias check’: ask, “Is this source trying to entertain, persuade, or inform? How can you tell?” (point of view)."
        ],
        "philosophy_connection": "This is sustained inquiry with scaffolding: you provide a structure (note-catcher, source labels) but Penny does the investigating and evidence selection for an authentic product."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Have Penny add a ‘Then vs. Now’ box: How is the creature used in modern media/tourism, and does that change its meaning?"
        ],
        "philosophy_connection": "The project remains central: Penny produces an authentic artifact that demonstrates learning, integrating research, geography tools, and argumentation."
      },
      {
        "type": "reflection",
        ...
        "extensions": [
          "Schedule a 10-minute ‘public exhibition’ later this week where Penny presents and answers 2 audience questions."
        ],
        "philosophy_connection": "Reflection and revision are built into PBL, and naming an authentic audience increases purpose and accountability."
      }
    ],
    "standards": [],
    ...
    "sections": [
      {
        ...
        "extensions": [
          "If Uma asks, show a short kid-friendly picture of yeast under a microscope and connect it back to “tiny helpers you can’t see.”"
        ],
        "philosophy_connection": "You’re offering a real-life, meaningful activity (bread-making) and trusting Uma to choose her level of participation, with you facilitating rather than directing."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Let Uma choose container shapes (tall cup vs wide bowl) to see which makes bubbles easier to spot."
        ],
        "philosophy_connection": "Uma’s curiosity sets the experiment. You’re supporting self-directed inquiry using everyday materials, with natural consequences (more/less bubbles) providing feedback."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Make a quick ‘bubble count’ game: point to 1–5 bubbles you can see and count them together only if Uma initiates counting."
        ],
        "philosophy_connection": "This keeps learning playful and voluntary, integrating science with imaginative play and real kitchen work rather than a forced worksheet sequence."
      },
      {
        "type": "reflection",
        ...
        "extensions": [
          "If you’re baking today, point out where you see bubbles in real dough and connect it to her jars."
        ],
        "philosophy_connection": "Reflection is conversational and child-owned. The model is a creative, hands-on way to represent what she observed, without demanding a single ‘right’ answer."
      },
      {
        "type": "transition",
        ...
        "extensions": [
          "Take a photo of each jar now and later so Uma can see change over time."
        ],
        "philosophy_connection": "You’re respecting autonomy and using natural consequences and real household rhythms to continue the learning without forcing closure."
      }
    ],
    "standards": [],
    ...
    "sections": [
      {
        ...
        "extensions": [
          "Have Adam pick one image and estimate: how many repeats around the circle (8? 12? 16?), and what might each central angle be (360/n)."
        ],
        "philosophy_connection": "Adaptive: you offer multiple ways to engage (visual art examples + discussion) and optimize autonomy by letting Adam choose an art style and math focus."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Add a second circle offset from the first (like a Venn/overlap composition) and decide which regions will be patterned differently."
        ],
        "philosophy_connection": "Adaptive: multiple means of representation (visual framework + labeled measurements) and action/expression (hand tools or alternative methods). You scaffold by turning an open-ended art task into manageable design constraints."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Have Adam set up a mini 'client requirement': 'The circle must have circumference about 50 cm.' Solve for r and adjust the design.",
          "If using wedges, connect to fractions: each wedge is 1/n of the circle; estimate wedge area as A/n."
        ],
        "philosophy_connection": "Adaptive: mastery-oriented feedback and gradual release—Adam uses formulas, then uses structure (scaling rules) to work smarter. Multiple means of engagement: he picks the math pathway that best matches his interest (scaling vs. ring areas)."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Add 8 or 12 chalk wedges and turn it into a game: label wedges with expressions or quick mental-math prompts."
        ],
        "philosophy_connection": "Adaptive: authentic, experiential learning and transfer—Adam generalizes from paper math to a real, physical circle and uses tools strategically."
      },
      {
        "type": "reflection",
        ...
        "extensions": [
          "Create a mini-display: tape the art up and add a 'Math Caption' card with the key calculations."
        ],
        "philosophy_connection": "Adaptive: multiple means of expression (writing or audio) and self-regulation through reflection and goal-setting for next time."
      }
    ],
    "standards": [],
    ...
    "sections": [
      {
        ...
        "extensions": [
          "Have Charlie give his narration as a dramatic 'tour guide' speech for a pretend visitor."
        ],
        "philosophy_connection": "Charlotte Mason picture study begins with attentive looking and personal relationship to the work, followed by narration for assimilation rather than interrogation."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Add a fourth artwork from your own family’s heritage or local community for an extra personal connection."
        ],
        "philosophy_connection": "This uses 'living ideas' through direct contact with great art and respects the child as a person by giving choice and space to form relationships with ideas."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Have Charlie add one physical feature near the location (ocean, mountain range, desert) and guess how it might influence materials or themes in art."
        ],
        "philosophy_connection": "Charlotte Mason geography builds relationships with real places through map work—connecting ideas (art) to the world rather than memorizing isolated facts."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Invite Charlie to find one additional secondary source (a second museum page) and notice whether the two descriptions emphasize different ideas (possible bias/point of view)."
        ],
        "philosophy_connection": "Living books and single-reading narration cultivate attention and self-education; comparing sources trains historical thinking without turning it into a worksheet."
      },
      {
        "type": "transition",
        ...
        "extensions": [
          "Try a 'limited palette' challenge: Charlie picks 3 colors he sees outdoors and uses only those to add small accents to his border."
        ],
        "philosophy_connection": "Nature study and observation walks train attention and connect 'books and things'—helping Charlie see that art grows from close noticing of the real world."
      },
      {
        "type": "reflection",
        ...
        "extensions": [
          "Have Charlie curate a 'mini exhibit' by arranging the three artworks and giving each a one-sentence label, then inviting another family member to visit."
        ],
        "philosophy_connection": "Narration and concise written composition help ideas become the child’s own, while keeping the tone respectful and non-competitive."
      }
    ],
    "standards": [],
    ...
    "sections": [
      {
        ...
        "extensions": [
          "Try the same verse while tossing a soft ball back and forth on each number.",
          "Switch to counting by 3s or 5s if he’s ready."
        ],
        "philosophy_connection": "Uses rhythm, movement, and spoken verse to bring math through the body (thinking-feeling-willing) before any paper work, in a Waldorf-adjacent way."
      },
      {
        "type": "introduction",
        ...
        "extensions": [
          "Let Wally retell the story back to you in his own words while pointing to the drawing.",
          "Add a second row in the drawing and let him notice it must switch (under-over) to lock in place."
        ],
        "philosophy_connection": "Introduces structure through vivid imagery and whole-to-part experience (a complete woven ‘picture’ first), rather than abstract explanation."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Add a simple border: fold down the ends and tape/glue to make it look finished.",
          "Try a 3-color repeating pattern (ABCABC) and have Wally name the pattern aloud."
        ],
        "philosophy_connection": "Hands-on making (will activity) is the heart of the lesson; mathematical structure is experienced through doing and artistic beauty, not through worksheets."
      },
      {
        "type": "exploration",
        ...
        "extensions": [
          "Ask: “Can we make a different rectangle that still has 24 squares?” (e.g., 2×12, 3×8, 4×6).",
          "Make a ‘woven’ rule: color every other square with chalk to create a checker pattern and discuss how many are shaded vs unshaded."
        ],
        "philosophy_connection": "Connects math to bodily movement and the outdoor world; Wally experiences number relationships as spatial forms (arrays) before abstract computation."
      },
      {
        "type": "practice",
        ...
        "extensions": [
          "Add a second grid on the same page showing a different rectangle with the same total area (e.g., 3×8) and write both equations.",
          "Invite him to label ‘rows’ and ‘columns’ with arrows."
        ],
        "philosophy_connection": "Main lesson book style integrates artistry and academic content; the child makes a personal, beautiful ‘whole’ page that holds the math meaningfully."
      },
      {
        "type": "reflection",
        ...
        "extensions": [
          "Record one sentence he says verbatim on the back of the page as a ‘child quote’ for your homeschool portfolio."
        ],
        "philosophy_connection": "Retelling and oral explanation strengthen memory and understanding without over-intellectualizing; it also honors relationship and gentle authority through your calm guiding questions."
      }
    ],
    "standards": [],
...
// Merge teasers into the raw lesson data. Keeps content and marketing copy
// in separate sources so either can be iterated on without touching the
// other.
