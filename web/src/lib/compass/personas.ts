...
export const PERSONAS: Persona[] = [
  {
    ...
    philosophyWeights: { classical: 1.0, charlotte_mason: 0.3, adaptive: 0.2 },
  ...
  },
  {
    ...
    philosophyWeights: { unschooling: 1.0, adaptive: 0.2, montessori: 0.1 },
  ...
  },
  {
    ...
    philosophyWeights: { project_based: 1.0, montessori: 0.2, place_nature: 0.2, adaptive: 0.2 },
  ...
  },
  {
    ...
    philosophyWeights: { adaptive: 1.0, charlotte_mason: 0.2, montessori: 0.2, project_based: 0.2 },
  ...
  },
  {
    ...
    expectedArchetype: "the-cultivator",
    philosophyWeights: { montessori: 0.6, classical: 0.3, project_based: 0.4, adaptive: 0.3 },
  ...
  },
  {
    ...
    expectedArchetype: "the-architect",
    philosophyWeights: { project_based: 0.6, classical: 0.3, place_nature: 0.3, adaptive: 0.3 },
  ...
  },
  {
    ...
    expectedArchetype: "the-explorer",
    philosophyWeights: { unschooling: 0.4, place_nature: 0.5, adaptive: 0.3, charlotte_mason: 0.2 },
  ...
  },
  {
    ...
    expectedArchetype: "the-guide",
    philosophyWeights: { classical: 0.5, project_based: 0.4, adaptive: 0.3, montessori: 0.2 },
  ...
  },
  {
    ...
    expectedArchetype: "the-weaver",
    philosophyWeights: { adaptive: 0.6, montessori: 0.2, charlotte_mason: 0.2, classical: 0.2 },
  ...
  },
  {
    ...
    expectedArchetype: "the-architect",
    philosophyWeights: { project_based: 0.8, montessori: 0.3, classical: 0.2, adaptive: 0.3 },
